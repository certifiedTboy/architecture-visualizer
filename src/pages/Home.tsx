...
interface HomeProps {
  ...
  filteredArchitectures: Architecture[];
}

export const Home = ({ filteredArchitectures }: HomeProps) => {
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      <div className="mb-10">
        ...
        <p className="text-md md:text-lg text-muted-foreground max-w-3xl">
          Explore interactive, highly detailed system design patterns. Perfect
          for studying, interview prep, or finding reference architectures for
          your next project.
        </p>
      </div>
